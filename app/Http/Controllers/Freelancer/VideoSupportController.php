...
class VideoSupportController extends Controller
{
    /**
     * Get all video support requests for the authenticated freelancer
     */
    public function index()
    {
        try {
            ...
            $requests = VideoSupportRequest::where('freelancer_id', $freelancerId)
            ...
            Log::error('Error fetching video support requests: ' . $e->getMessage());
            return response()->json([
                'success' => false,
    ...
    /**
     * Create a new video support request
     */
    public function store(Request $request)
    {
        try {
            ...
            Log::error('Error creating video support request: ' . $e->getMessage());
            return response()->json([
                'success' => false,
